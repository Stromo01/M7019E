...
fun MovieDetailScreen(
    ...
    movieResponse: MovieResponse, favMovie: FavoriteMovieHandler, isNetworkAvailable: Boolean
) {
    if(!isNetworkAvailable){
        Column(
            ...
            Text(text = "No Internet Connection", fontSize = 28.sp, fontWeight = FontWeight.Bold)
        ...
        selectedMovie?.let { movie ->
            ...
            movieDetails?.let {
                Column(
                    ...
                    // Heart Icon
                    val isFavorite =
                        remember { mutableStateOf(favMovie.isFavorite(it.id.toString())) }
                    IconButton(
                        onClick = {
